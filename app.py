...
if user_answer:
    ...
    if user_request == "paycheck":
        ...
        if ord_utils.handle_tips_request():
            ...
            order_cost = orders.calculate_order_cost(name=name, surname=surname)
        ...
        if user_input == "food":
            ...
            if ord_utils.handle_add_drinks():
                print("Here is our drinks menu: ")
                menu.show_all_drinks()
                alcohol = {}
                alc_free = {}
...
user_answer = ord_utils.handle_call_waiter()
while True:
    if ord_utils.handle_paycheck_request():
        # ADD RECEIPT LOGGING
        # ADD RECEIPT LOGGING
        # ADD RECEIPT LOGGING
        # ADD RECEIPT LOGGING
        ...
        print("We think it is time for you to pay and leave :)")
